...
usage: generate.py [-h] [--inv INVENTORY] [--cat CATALOG] [--bandpasslow BPL]
                   [--bandpasshigh BPH] [--outdata DATA] [--outrf RFF]
                   asdffile
...
optional arguments:
  ...
  --bandpasslow BPL   lower threshold for the band pass filter.
  --bandpasshigh BPH  higher threshold for the band pass filter..
